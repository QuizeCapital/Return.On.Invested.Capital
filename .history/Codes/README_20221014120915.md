...
The 'quintiledROIC' function takes the quintiled ROIC data and returns a lit of dictionaries containing year as key and tickers of five quintiles as values
