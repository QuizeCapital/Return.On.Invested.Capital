...
and gets marketcap , ROIC, historical price, S&P data(both quarterly and ) from various sections as bulk data. Takes original ticker data as parameter and returns returns each tickers data.
