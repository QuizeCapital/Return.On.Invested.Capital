...
class ROIC():
    ...
    def cummulativeAnnualGrowthRateQuintiles(self):
        ...
        return valueList
    '''
    This function takes the quintiled ROIC tickers segement reperesented by  data and CAGRs  
    cross checks them and matches the tickers according to their quintiles 
    to their CAGR. It then returns a list containing the quintile tickers  and their
    '''
