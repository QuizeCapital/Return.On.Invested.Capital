...
The Eps Data.json file (/Users/adamszequi/Desktop/Clones/ROIC /Data/Annual Historical Prices.json) contains columns of Ticker Name, date  and Earnings per share as a dictionary  in the format{{key:}key:value} .
